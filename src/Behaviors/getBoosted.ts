...
export function getBoosted(creep: Creep, mission: Mission<MissionType>) {
    ...
    const outstanding = Memory.offices[mission.office].lab.boosts
    ...
    if (outstanding.length === 0) {
        ...
        Memory.offices[mission.office].lab.boosts = Memory.offices[mission.office].lab.boosts.filter(o => o.name !== creep.name)
    ...
    const targetLab = Memory.offices[mission.office].lab.boostingLabs.find(l => outstanding.some(o => o.type === l.resource));

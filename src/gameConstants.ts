...
export const BUILD_COSTS_BY_RCL: Record<number, number> = {
  ...
  4:
    CONSTRUCTION_COST[STRUCTURE_EXTENSION] * 10 +
...
export const RESOURCE_INGREDIENTS: Record<MineralCompoundConstant, [LabMineralConstant, LabMineralConstant]> = {
...
export const BOOSTS_BY_INTENT = {
  ATTACK: [RESOURCE_CATALYZED_UTRIUM_ACID, RESOURCE_UTRIUM_ACID, RESOURCE_UTRIUM_HYDRIDE, null],
  HARVEST: [RESOURCE_CATALYZED_UTRIUM_ALKALIDE, RESOURCE_UTRIUM_ALKALIDE, RESOURCE_UTRIUM_OXIDE, null],
  CARRY: [RESOURCE_CATALYZED_KEANIUM_ACID, RESOURCE_KEANIUM_ACID, RESOURCE_KEANIUM_HYDRIDE, null],
  RANGED_ATTACK: [RESOURCE_CATALYZED_KEANIUM_ALKALIDE, RESOURCE_KEANIUM_ALKALIDE, RESOURCE_KEANIUM_OXIDE, null],
  BUILD: [RESOURCE_CATALYZED_LEMERGIUM_ACID, RESOURCE_LEMERGIUM_ACID, RESOURCE_LEMERGIUM_HYDRIDE, null],
  REPAIR: [RESOURCE_CATALYZED_LEMERGIUM_ACID, RESOURCE_LEMERGIUM_ACID, RESOURCE_LEMERGIUM_HYDRIDE, null],
  HEAL: [RESOURCE_CATALYZED_LEMERGIUM_ALKALIDE, RESOURCE_LEMERGIUM_ALKALIDE, RESOURCE_LEMERGIUM_OXIDE, null],
  RANGED_HEAL: [RESOURCE_CATALYZED_LEMERGIUM_ALKALIDE, RESOURCE_LEMERGIUM_ALKALIDE, RESOURCE_LEMERGIUM_OXIDE, null],
  DISMANTLE: [RESOURCE_CATALYZED_ZYNTHIUM_ACID, RESOURCE_ZYNTHIUM_ACID, RESOURCE_ZYNTHIUM_HYDRIDE, null],
  MOVE: [RESOURCE_CATALYZED_ZYNTHIUM_ALKALIDE, RESOURCE_ZYNTHIUM_ALKALIDE, RESOURCE_ZYNTHIUM_OXIDE, null],
  UPGRADE: [RESOURCE_CATALYZED_GHODIUM_ACID, RESOURCE_GHODIUM_ACID, RESOURCE_GHODIUM_HYDRIDE, null],
  TOUGH: [RESOURCE_CATALYZED_GHODIUM_ALKALIDE, RESOURCE_GHODIUM_ALKALIDE, RESOURCE_GHODIUM_OXIDE, null]
};

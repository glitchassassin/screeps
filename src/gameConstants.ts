...
export const BOOSTS_BY_INTENT: Record<string, MineralBoostConstant[]> = {
  ...
  CARRY: [RESOURCE_CATALYZED_KEANIUM_ACID, RESOURCE_KEANIUM_ACID, RESOURCE_KEANIUM_HYDRIDE],
  ...
  REPAIR: [RESOURCE_CATALYZED_LEMERGIUM_ACID, RESOURCE_LEMERGIUM_ACID, RESOURCE_LEMERGIUM_HYDRIDE],
  HEAL: [RESOURCE_CATALYZED_LEMERGIUM_ALKALIDE, RESOURCE_LEMERGIUM_ALKALIDE, RESOURCE_LEMERGIUM_OXIDE],
  RANGED_HEAL: [RESOURCE_CATALYZED_LEMERGIUM_ALKALIDE, RESOURCE_LEMERGIUM_ALKALIDE, RESOURCE_LEMERGIUM_OXIDE],
